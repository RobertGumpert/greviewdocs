...
64      [ spill slot        ] <- сюда func1 запишет x
...
0000000000479960 <main.main>:
  ...
  movq	%rsp, %rbp            # копируем в RBP значение RBP, и получаем RBP для main.main  - RBP = 992
